...
An example of it in use can be found at my [Pac-Man emulator](https://github.com/amelliyaa/pacman).
...
z80
GIT_REPOSITORY "https://github.com/amelliyaa/z80.git"
)
set(TEST_Z80 OFF)
...
### With CMake
```angular2html
git clone https://github.com/amelliyaa/z80.git
cd z80/
